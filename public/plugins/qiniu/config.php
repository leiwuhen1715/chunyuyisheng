...
return [
    'accessKey'                 => [// 在后台插件配置表单中的键名 ,会是config[text]
        ...
        'tip'     => '<a href="https://portal.qiniu.com/qvm/active?code=1381757652Gn5y" target="_blank">马上获取</a>' //表单的帮助提示
    ],
...
//        ],
        ...
        'tip'     => '请到七牛存储空间->图片样式：添加此样式名称，并进行相应设置 处理接口<span style="color: red;">（请注意修改水印文字）</span>:<br>imageMogr2/auto-orient/blur/1x0/quality/100'
    ],
    'styles_avatar'             => [
        'title'   => '样式-头像',
        'type'    => 'explain',
...
//        ],
        ...
        'tip'     => '请到七牛存储空间->图片样式：添加此样式名称，并进行相应设置<br>处理接口:<br> imageMogr2/auto-orient/blur/1x0/quality/100'
